...
def train_model():
    ...
    input_data_s3 = f"s3://{S3_BUCKET}/data/iris_train.csv/"
    output_data_s3 = f"s3://{S3_BUCKET}/data/iris-output/"
    ...
    response = client.create_training_job(
        ...
        InputDataConfig=[
            {
                "ChannelName": "train",
                "DataSource": {"S3DataSource": {"S3DataType": "S3Prefix", "S3Uri": input_data_s3, "S3DataDistributionType": "FullyReplicated"}},
...
def deploy_model():
    ...
    model_data = f"s3://{S3_BUCKET}/iris-output/iris_model.tar.gz"
    container = {"Image": "605134428434.dkr.ecr.us-east-1.amazonaws.com/ecr-iris-repo1:latest", "ModelDataUrl": model_data}
